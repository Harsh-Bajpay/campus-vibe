      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Campus Vibe brings together all the tools and features you need to enhance your college experience
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 border border-blue-200 dark:border-blue-800">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Get instant updates about upcoming events, workshops, and activities happening on campus
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 border border-purple-200 dark:border-purple-800">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Discover and join student clubs, manage memberships, and collaborate with peers
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 border border-green-200 dark:border-green-800">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Access shared notes, study guides, and learning materials from fellow students
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 border border-orange-200 dark:border-orange-800">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Sync campus events with your personal calendar and never miss important dates
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-pink-50 to-pink-100 dark:from-pink-900/20 dark:to-pink-800/20 border border-pink-200 dark:border-pink-800">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Engage in meaningful discussions, ask questions, and share knowledge with peers
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-900/20 dark:to-indigo-800/20 border border-indigo-200 dark:border-indigo-800">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Connect with career advisors, find internships, and explore job opportunities
            </p>
          </div>
        </div>
      </div>
